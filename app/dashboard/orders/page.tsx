...
import { ShoppingCart, Package, Calendar, MapPin, Loader2, Eye, Trash2 } from "lucide-react"
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="bg-white/90 backdrop-blur-sm border-yellow-100 hover:shadow-lg transition-all duration-300">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
